...
See [gamekit turn gating](/concepts/gamekit-permissions-and-turns).

## Views and computed

Computed values are selectors under a friendlier name. You read them as `C` inside moves and views. Use them to avoid recomputing derived facts in every code path.
...
- [Gamekit turn gating](/concepts/gamekit-permissions-and-turns) covers turn-gating patterns.
