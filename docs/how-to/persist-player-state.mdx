...
The only operator step is making sure the `profile` / `profile_commit` tables exist. They're part of the normal Drizzle migrations under [`openturn-cloud/drizzle/`](https://github.com/openturn-io/openturn/tree/main/openturn-cloud/drizzle). Run your usual migration command.
