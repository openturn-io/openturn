...
Before you deploy to Cloudflare, you want to prove the multiplayer flow on your own machine. `openturn dev` runs a production-shaped hosted stack against your project's `app/` folder. No cloud credentials, no network configuration.
...
- [How-to: deploy to Cloudflare](/how-to/deploy-to-cloudflare) for the production path.
