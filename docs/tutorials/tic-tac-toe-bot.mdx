...
Cloud play uses `attachHostedBot` against a `HostedClient`, with the bot living in a separate sidecar process — see [Concepts: bots](/concepts/bots#cloud-deployment).
...
- [How-to: add a bot](/how-to/add-a-bot) — practical recipes for heuristic and search-based bots.
