...
import { paperScissorsRock } from "@openturn/example-paper-scissors-rock-game";
...
describe("PaperScissorsRockExperience", () => {
  test("renders the initial match state", () => {
    ...
    expect(screen.getByText("Hidden turns. Shared round. Gamekit authoring.")).toBeTruthy();
    expect(screen.getByText("Gamekit + core state")).toBeTruthy();
